...
class FeedItemMapper @Inject constructor(): CacheEntityMapper<FeedDataItem, CachedFeedItem> {

    override fun mapToCache(e: FeedDataItem): CachedFeedItem {
        return CachedFeedItem(e.id, e.publicationDate, e.sectionName, System.currentTimeMillis(), e.webUrl, e.headline, e.wordCount, e.thumbnail, null, null, e.pageNo, null)
    }
