package com.abhrp.daily.domain.usecase

import com.abhrp.daily.common.ApplicationExceptions
...
abstract class SingleUseCase<T, P>(private val postExecutionThread: PostExecutionThread?) {
    ...
    fun execute(observer: DisposableSingleObserver<T>?, params: P? = null) {
        ...
        requireNotNull(postExecutionThread) { ApplicationExceptions.NO_NULL_EXECUTOR }
